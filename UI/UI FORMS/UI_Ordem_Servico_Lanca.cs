...
{
    public partial class UI_Ordem_Servico_Lanca : Form
    {
        public UI_Ordem_Servico_Lanca()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                switch (TipoPagamento)
                {
                    ...
                    case 2://CARTÃO
                        ...
                        Lancamento.CReceber.ID_Conta = Parametro_Financeiro.ID_Conta_FatOS;
                        Lancamento.CReceber.TipoPessoa = TipoPessoa;
                        Lancamento.CReceber.ID_Pessoa = ID_Pessoa;
                        Lancamento.CReceber.Descricao = "OS Nº " + Documento + " - " + Descricao_Pessoa;
                    ...
                    case 4://DINHEIRO
                        ...
                        Lancamento.FluxoCaixa.ID_Conta = Parametro_Financeiro.ID_Conta_FatOS;
                        Lancamento.FluxoCaixa.Credito = Convert.ToDouble(Convert.ToDouble(txt_Valor.Text));
                        Lancamento.FluxoCaixa.Debito = 0;
                        Lancamento.FluxoCaixa.Informacao = "OS Nº " + Documento + " - " + Descricao_Pessoa;
                    ...
                    for (int i = 0; i <= Lst_Lancamento.Count - 1; i++)
                        switch (Lst_Lancamento[i].Tipo)
                        {
                            case 0://BAIXA CHEQUE, LANCAMENTO FINANCEIRO
                                ...
                                CReceber.ID_Conta = Parametro_Financeiro.ID_Conta_FatOS;
                                CReceber.Situacao = 2;
                                ...
                                CReceber.Descricao = util_msg.msg_LancaOS + Documento;
                                CReceber.Controle = 0;
                                CReceber.Boleto = false;
                                CReceber.DataBaixa = Lst_Lancamento[i].CReceber.Vencimento;
                                CReceber.ID_OS = Convert.ToInt32(Documento);
                            ...
                            case 3://CHEQUE
                                ...
                                Cheque.Informacao = util_msg.msg_LancaOS + Documento + " (" + Lst_Lancamento[i].Cheque.Informacao + ")";
                                ...
                                FluxoCaixa.ID_Conta = Parametro_Financeiro.ID_Conta_FatOS;
                                FluxoCaixa.Credito = Lst_Lancamento[i].Cheque.Valor;
                                FluxoCaixa.Debito = 0;
                                FluxoCaixa.Informacao = util_msg.msg_LancaOS + Documento + " " + util_msg.msg_LancaCheque + Lst_Lancamento[i].Cheque.Cheque;
                            ...
                            case 4://DINHEIRO
                                ...
                                FluxoCaixa.Debito = 0;
                                FluxoCaixa.Informacao = util_msg.msg_LancaOS + Documento;
        ...
        #region FORM
        private void UI_Ordem_Servico_Lanca_Load(object sender, EventArgs e)
        {
        ...
        private void UI_Ordem_Servico_Lanca_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (Concluido == false)
            {
                DialogResult msgbox;
        ...
        private void UI_Ordem_Servico_Lanca_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void bt_Concluido_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToDouble(txt_Diferenca.Text) < 0)
            {
                ...
                FluxoCaixa.Informacao = "TROCO - OS Nº " + Documento;
