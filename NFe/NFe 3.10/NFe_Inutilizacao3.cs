...
using System.Xml;
using Sistema.NFe.ws_NFeInutilizacao2;
using Sistema.UTIL;
using Sistema.DTO;
using Sistema.BLL;
...
{
    public class NFe_Inutilizacao3
    {
        public string Transmite_XML(string XML, string Certificado)
        {
            try
            {
                ...
                XmlNodeList _ide = xml.GetElementsByTagName("infInut");
                ...
                NfeInutilizacao2 ws = new NfeInutilizacao2();
                ...
                return ws.nfeInutilizacaoNF2(xdoc).OuterXml;
            }
            catch (Exception ex)
            {
            ...
            if (_Mod == 55)
                switch (_Amb)
                {
                    case "1":
                        ...
                        {
                            case "31":
                                return "https://nfe.fazenda.mg.gov.br/nfe2/services/NfeInutilizacao2";

                            case "35":
                                return "https://nfe.fazenda.sp.gov.br/ws/nfeinutilizacao2.asmx";
                    ...
                    case "2":
                        ...
                        {
                            case "31":
                                return "https://hnfe.fazenda.mg.gov.br/nfe2/services/NfeInutilizacao2";

                            case "35":
                                return "https://homologacao.nfe.fazenda.sp.gov.br/ws/nfeinutilizacao2.asmx";
            ...
            if (_Mod == 65)
                switch (_Amb)
                {
                    case "1":
                        ...
                        {
                            case "35":
                                return "https://nfce.fazenda.sp.gov.br/ws/nfeinutilizacao2.asmx ";
                    ...
                    case "2":
                        ...
                        {
                            case "35":
                                return "https://homologacao.nfce.fazenda.sp.gov.br/ws/nfeinutilizacao2.asmx ";
